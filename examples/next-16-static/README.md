# Next 16 Static Quick Start

Use this pattern when your Next 16 app uses static export and you want OpenNav
...
This example sets `turbopack.root` so the fixture stays isolated inside the
repository. Your app may not need that option unless Next asks for it.
